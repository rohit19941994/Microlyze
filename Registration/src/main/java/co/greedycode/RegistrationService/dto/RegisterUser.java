...
public class RegisterUser implements Serializable {
  ...
  public RegisterUser id(Integer id) {
  ...
  **/
  ...
  public RegisterUser status(String status) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Successfully Registered", value = "")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, registerUser.id) &&
        Objects.equals(this.email, registerUser.email) &&
        Objects.equals(this.status, registerUser.status);
  }
